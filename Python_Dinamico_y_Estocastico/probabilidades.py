...
def run(numero_de_tiros, numero_de_intentos):
    tiros = []
    ...
    print(f"La probabilidad de obtener por lo menos un 1 en {numero_de_tiros} tiros = {probabilidad_de_tiros_con_1}")
...
if __name__ == "__main__":
    ...
    run(numero_de_tiros, numero_de_intentos)
